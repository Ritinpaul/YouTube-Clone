...
import { IoMdMic, IoIosSearch } from "react-icons/io";
...
function Navbar() {
  ...
  if (searchbar) {
    return <div className="flex justify-between fixed top-0 w-[100%] bg-white px-6 py-2 items-center">
      ...
      <div className="flex flex-grow items-center mx-3">
  ...
  return (
    <div className="flex justify-between fixed top-0 w-[100%] bg-white px-6 py-2 ">
      ...
      <div className="flex  space-x-5 items-center ">
        <IoIosSearch className="text-2xl md:hidden cursor-pointer" onClick={() => setSearchbar(!searchbar)} />
